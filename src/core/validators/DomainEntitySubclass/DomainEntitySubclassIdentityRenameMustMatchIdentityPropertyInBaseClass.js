    ...
    (function (Core) {
        ...
        (function (Validator) {
            ...
            (function (DomainEntitySubclass) {
                class DomainEntitySubclassIdentityRenameMustMatchIdentityPropertyInBaseClass {
                }
                ValidationRuleBase < MetaEdGrammar.DomainEntitySubclassContext >
                    {
                        readonly: ISymbolTable, _symbolTable: ,
                        DomainEntitySubclassIdentityRenameMustMatchIdentityPropertyInBaseClass(ISymbolTable = symbolTable) {
