    ...
    (function (Core) {
        ...
        (function (Validator) {
            ...
            (function (DomainEntitySubclass) {
                class DomainEntitySubclassIdentityRenameMustExistNoMoreThanOnce extends ValidationRuleBase {
                    isValid(context) {
                ...
                DomainEntitySubclass.DomainEntitySubclassIdentityRenameMustExistNoMoreThanOnce = DomainEntitySubclassIdentityRenameMustExistNoMoreThanOnce;
