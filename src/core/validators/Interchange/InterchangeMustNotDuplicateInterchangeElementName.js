    ...
    (function (Core) {
        ...
        (function (Validator) {
            ...
            (function (Interchange) {
                class InterchangeMustNotDuplicateInterchangeElementName extends ValidationRuleBase {
                ...
                Interchange.InterchangeMustNotDuplicateInterchangeElementName = InterchangeMustNotDuplicateInterchangeElementName;
