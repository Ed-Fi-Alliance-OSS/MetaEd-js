...
(function (MetaEd) {
    ...
    (function (Core) {
        ...
        (function (Validator) {
            var Domain;
            (function (Domain) {
                class DomainMustNotDuplicateDomainItems {
                }
                ValidationRuleBase < MetaEdGrammar.DomainContext >
                    {
                        string: [], GetDuplicateDomainItems(MetaEdGrammar, DomainContext = context) {
                        ...
                        override: bool, IsValid(MetaEdGrammar, DomainContext = context) {
                            return !GetDuplicateDomainItems(context).Any();
                        },
                        override: string, GetFailureMessage(MetaEdGrammar, DomainContext = context) {
