    ...
    (function (Core) {
        ...
        (function (Validator) {
            ...
            (function (DecimalProperty) {
                class DecimalPropertyMustNotMatchACommonSimpleType extends ValidationRuleBase {
                ...
                DecimalProperty.DecimalPropertyMustNotMatchACommonSimpleType = DecimalPropertyMustNotMatchACommonSimpleType;
