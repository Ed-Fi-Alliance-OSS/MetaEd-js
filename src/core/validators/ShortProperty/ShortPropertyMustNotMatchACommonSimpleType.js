    ...
    (function (Core) {
        ...
        (function (Validator) {
            ...
            (function (ShortProperty) {
                class ShortPropertyMustNotMatchACommonSimpleType extends ValidationRuleBase {
                ...
                ShortProperty.ShortPropertyMustNotMatchACommonSimpleType = ShortPropertyMustNotMatchACommonSimpleType;
