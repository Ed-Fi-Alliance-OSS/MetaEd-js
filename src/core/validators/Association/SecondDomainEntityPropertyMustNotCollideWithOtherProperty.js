    ...
    (function (Core) {
        ...
        (function (Validator) {
            ...
            (function (Association) {
                class SecondDomainEntityPropertyMustNotCollideWithOtherProperty extends ValidationRuleBase {
                ...
                Association.SecondDomainEntityPropertyMustNotCollideWithOtherProperty = SecondDomainEntityPropertyMustNotCollideWithOtherProperty;
