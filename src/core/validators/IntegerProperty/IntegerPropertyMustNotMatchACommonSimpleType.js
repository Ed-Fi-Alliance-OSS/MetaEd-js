    ...
    (function (Core) {
        ...
        (function (Validator) {
            ...
            (function (IntegerProperty) {
                class IntegerPropertyMustNotMatchACommonSimpleType extends ValidationRuleBase {
                ...
                IntegerProperty.IntegerPropertyMustNotMatchACommonSimpleType = IntegerPropertyMustNotMatchACommonSimpleType;
