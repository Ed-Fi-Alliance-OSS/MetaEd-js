import { newMetaEdEnvironment, newAssociation, newDomainEntitySubclass, newNamespace } from '@edfi/metaed-core';
import { MetaEdEnvironment, Association, DomainEntitySubclass, Namespace } from '@edfi/metaed-core';
