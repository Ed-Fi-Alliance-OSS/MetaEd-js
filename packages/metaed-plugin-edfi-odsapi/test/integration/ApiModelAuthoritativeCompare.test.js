...
describe('when generating api model targeting tech version 3.1.1 and comparing it to data standard 3.1 authoritative artifacts', () => {
  ...
  beforeAll(async () => {
    ...
    state.metaEd.dataStandardVersion = '3.1.1';
...
describe('when generating api model with simple type merge extensions and comparing it to data standard 3.1 authoritative artifacts', () => {
  ...
  const authoritativeCoreFilename: string = 'edfi-3.1-api-model-authoritative.json';
  const authoritativeExtensionFilename: string = 'edfi-3.1-api-model-simple-type-merge-extension-authoritative.json';
  const generatedCoreFilename: string = 'edfi-3.1-api-model-core-with-simple-type-merge-generated.json';
  const generatedExtensionFilename: string = 'edfi-3.1-api-model-simple-type-merge-extension-generated.json';
