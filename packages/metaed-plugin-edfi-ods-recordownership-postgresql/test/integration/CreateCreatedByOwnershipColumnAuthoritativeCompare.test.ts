...
describe('when generating CreatedByOwnership columns and comparing to ODS/API 6.0 authoritative artifacts', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact');
  const authoritativeFilename = 'CreatedByOwnership-v6.0-authoritative.sql';
  const generatedFilename = 'CreatedByOwnership-v6.0-generated.sql';
