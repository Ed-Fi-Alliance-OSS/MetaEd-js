        ...
        if (
          ...
          failures.push(
            getFailure(
              ...
              `Association Subdomain Item property '${domainItem.metaEdName}' does not match any declared Association or Association Subclass in namespace ${domainItem.referencedNamespaceName}.`,
            ),
          );
        }
      });
