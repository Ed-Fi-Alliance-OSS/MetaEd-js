 ...
 *
 * Only root-scope Namespace values qualify. A Namespace inside an array container describes a single
 * collection item, not the document as a whole, so it cannot serve as an authorization securable for
 * the document.
 */
