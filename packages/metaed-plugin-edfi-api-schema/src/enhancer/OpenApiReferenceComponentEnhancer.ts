...
function openApiReferenceComponentFor(entity: TopLevelEntity, schoolYearOpenApis: SchoolYearOpenApis): OpenApiObject {
  ...
  flattenedIdentityPropertiesOmittingMerges.forEach((flattenedIdentityProperty: FlattenedIdentityProperty) => {
    ...
    const openApiProperty: OpenApiProperty = {
      ...openApiPropertyForNonReference(flattenedIdentityProperty.identityProperty, schoolYearOpenApis),
      ...
      ...(flattenedIdentityProperty.identityProperty.isOptional && {
        'x-nullable': true,
      }),
      // Add x-Ed-Fi-deprecated extension for deprecated identity properties
      ...(flattenedIdentityProperty.identityProperty.isDeprecated && {
        'x-Ed-Fi-isDeprecated': true,
        'x-Ed-Fi-deprecatedReasons': flattenedIdentityProperty.identityProperty.deprecationReason,
      }),
    };
