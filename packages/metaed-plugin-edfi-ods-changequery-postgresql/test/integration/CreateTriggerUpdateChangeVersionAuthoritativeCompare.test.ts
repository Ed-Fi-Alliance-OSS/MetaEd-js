...
describe('when generating change event scripts and comparing to ODS/API 3.4 authoritative artifacts', (): void => {
  ...
  const authoritativeFilename = 'TriggerUpdateChangeVersion-v3.4-Authoritative.sql';
  const generatedFilename = 'TriggerUpdateChangeVersion-v3.4.sql';
...
describe('when generating change event scripts with simple extensions and comparing to ODS/API 3.4 authoritative artifacts', (): void => {
  ...
  const authoritativeCoreFilename = 'TriggerUpdateChangeVersion-v3.4-Authoritative.sql';
  const authoritativeExtensionFilename = 'sample-TriggerUpdateChangeVersion-v3.4-Authoritative.sql';
  const generatedCoreFilename = 'TriggerUpdateChangeVersion-v3.4.sql';
  const generatedExtensionFilename = 'sample-TriggerUpdateChangeVersion-v3.4.sql';
...
describe('when generating change event scripts and comparing to ODS/API 6.0.0 authoritative artifacts', (): void => {
  ...
  const generatedFilename = 'TriggerUpdateChangeVersion-v6.0.sql';
...
describe('when generating change event scripts with simple extensions and comparing to ODS/API 6.0 authoritative artifacts in Alliance mode', (): void => {
  ...
  const generatedCoreFilename = 'TriggerUpdateChangeVersion-v6.0-Alliance.sql';
  const generatedExtensionFilename = 'sample-TriggerUpdateChangeVersion-v6.0-Alliance.sql';
