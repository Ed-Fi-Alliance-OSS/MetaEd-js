...
describe('when generating change event scripts and comparing to ODS/API 6.0.0 authoritative artifacts', (): void => {
  ...
  const authoritativeFilename = 'TriggerUpdateChangeVersion-v6.0-authoritative.sql';
  const generatedFilename = 'TriggerUpdateChangeVersion-v6.0-generated.sql';
...
describe('when generating change event scripts with simple extensions and comparing to ODS/API 6.0 authoritative artifacts in Alliance mode', (): void => {
  ...
  const authoritativeCoreFilename = 'TriggerUpdateChangeVersion-v6.0-Alliance-authoritative.sql';
  const authoritativeExtensionFilename = 'sample-TriggerUpdateChangeVersion-v6.0-Alliance-authoritative.sql';
  const generatedCoreFilename = 'TriggerUpdateChangeVersion-v6.0-Alliance-generated.sql';
  const generatedExtensionFilename = 'sample-TriggerUpdateChangeVersion-v6.0-Alliance-generated.sql';
...
describe('when generating change event scripts with simple extensions and comparing to ODS/API 7.3.0 with DS 6.0 authoritative artifacts', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/update-trigger');
  const sampleExtensionPath: string = path.resolve(__dirname, './student-transcript-extension-project');
  const authoritativeCoreFilename = 'TriggerUpdateChangeVersion-v7.3-ds60-authoritative.sql';
  const authoritativeExtensionFilename = 'sample-TriggerUpdateChangeVersion-v7.3-ds60-authoritative.sql';
  const generatedCoreFilename = 'TriggerUpdateChangeVersion-v7.3-ds60-generated.sql';
  const generatedExtensionFilename = 'sample-TriggerUpdateChangeVersion-v7.3-ds60-generated.sql';
  ...
  beforeAll(async () => {
    const metaEdConfiguration = {
      ...
      artifactDirectory: './MetaEdOutput/',
      defaultPluginTechVersion: '7.3.0',
      projectPaths: ['./node_modules/@edfi/ed-fi-model-6.0/', sampleExtensionPath],
      projects: [
        {
          projectName: 'Ed-Fi',
          namespaceName: 'EdFi',
...
describe('when generating change event scripts with simple extensions and comparing to ODS/API 7.3.0 with DS 6.1 authoritative artifacts', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/update-trigger');
  const sampleExtensionPath: string = path.resolve(__dirname, './student-transcript-extension-project');
  const authoritativeCoreFilename = 'TriggerUpdateChangeVersion-v7.3-ds61-authoritative.sql';
  const authoritativeExtensionFilename = 'sample-TriggerUpdateChangeVersion-v7.3-ds61-authoritative.sql';
  const generatedCoreFilename = 'TriggerUpdateChangeVersion-v7.3-ds61-generated.sql';
  const generatedExtensionFilename = 'sample-TriggerUpdateChangeVersion-v7.3-ds61-generated.sql';
  ...
  beforeAll(async () => {
    const metaEdConfiguration = {
      ...
      artifactDirectory: './MetaEdOutput/',
      defaultPluginTechVersion: '7.3.0',
      projectPaths: ['./node_modules/@edfi/ed-fi-model-6.1/', sampleExtensionPath],
      projects: [
        {
          projectName: 'Ed-Fi',
          namespaceName: 'EdFi',
