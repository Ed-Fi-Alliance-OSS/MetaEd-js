...
describe('when generating ods and comparing it to data standard 6.1 authoritative artifacts for ODS/API 7.3', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v7.3_ds6.1/');
...
describe('when generating CreateEducationOrganizationAuthorizationIndexes and comparing it to data standard 6.1 authoritative artifacts for ODS/API 7.3', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v7.3_ds6.1/');
  const outputDirectory = `${artifactPath}`;
  let coreResult: GeneratedOutput;
  let coreFileBaseName: string;
...
describe('when generating UpdateEducationOrganizationAuthorizationIndexes and comparing it to data standard 6.1 authoritative artifacts for ODS/API 7.3', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v7.3_ds6.1/');
  const outputDirectory = `${artifactPath}`;
  let coreResult: GeneratedOutput;
  let coreFileBaseName: string;
...
describe('when generating AggregateIdColumns and comparing it to data standard 6.1 authoritative artifacts for ODS/API 7.3', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v7.3_ds6.1/');
  const outputDirectory = `${artifactPath}`;
  let coreResult: GeneratedOutput;
  let coreFileBaseName: string;
...
describe('when generating ods with simple extensions and comparing it to data standard 6.1 authoritative artifacts for ODS/API 7.3', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v7.3_ds6.1/');
...
describe('when generating ods with student transcript extensions and comparing it to data standard 6.1 authoritative artifacts for ODS/API 7.3', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v7.3_ds6.1/');
