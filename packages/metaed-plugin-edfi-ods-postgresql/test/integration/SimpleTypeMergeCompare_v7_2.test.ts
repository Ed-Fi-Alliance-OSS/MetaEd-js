...
describe('when generating ods tables file with simple merges for ODS/API 7.2', (): void => {
...
describe('when generating ods foreign keys file with simple merges for ODS/API v7.2', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v7_2/');
  const sampleExtensionPath: string = path.resolve(__dirname, './simple-type-merge-project');
...
describe('when generating EducationOrganizationAuthorizationIndexes with simple merges for ODS/API v7.2', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v7_2/');
  const sampleExtensionPath: string = path.resolve(__dirname, './simple-type-merge-project');
