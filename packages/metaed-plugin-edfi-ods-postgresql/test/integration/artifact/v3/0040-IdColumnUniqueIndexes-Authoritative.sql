...
CREATE UNIQUE INDEX IF NOT EXISTS UX_fb1ef3_Id ON edfi.AccountCode(Id);

CREATE UNIQUE INDEX IF NOT EXISTS UX_c40642_Id ON edfi.Actual(Id);
...
CREATE UNIQUE INDEX IF NOT EXISTS UX_57ca0f_Id ON edfi.ContractedStaff(Id);
