...
describe('when generating ods and comparing it to data standard 3.1 authoritative artifacts', (): void => {
...
describe('when generating ods with student transcript extensions and comparing it to data standard 3.0 authoritative artifacts', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v3/');
