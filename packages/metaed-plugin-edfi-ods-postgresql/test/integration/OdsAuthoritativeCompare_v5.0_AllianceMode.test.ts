...
describe('when generating ods and comparing it to data standard 3.2c authoritative artifacts for ODS/API 5.0.0 in Alliance mode', (): void => {
...
describe('when generating ods with simple extensions and comparing it to data standard 3.2c authoritative artifacts for ODS/API 5.0.0 in Alliance Mode', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v5_AllianceMode/');
...
describe('when generating ods with student transcript extensions and comparing it to data standard 3.2c authoritative artifacts for ODS/API 5.0.0 in Alliance mode', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/v5_AllianceMode/');
