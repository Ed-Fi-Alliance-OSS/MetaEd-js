...
BEGIN
    ...
    SELECT  AcademicSubjectDescriptorId, AssessedGradeLevelDescriptorId, AssessmentTitle, AssessmentVersion, IdentificationCode, Id, (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
END
GO
...
BEGIN
    ...
    SELECT  AcademicSubjectDescriptorId, AssessedGradeLevelDescriptorId, AssessmentTitle, AssessmentVersion, Id, (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
END
GO
...
BEGIN
    ...
    SELECT  AcademicSubjectDescriptorId, Objective, ObjectiveGradeLevelDescriptorId, Id, (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
END
GO
...
BEGIN
    ...
    SELECT  AcademicSubjectDescriptorId, AdministrationDate, AssessedGradeLevelDescriptorId, AssessmentTitle, AssessmentVersion, StudentUSI, Id, (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
END
GO
...
BEGIN
    ...
    SELECT  AcademicSubjectDescriptorId, GradingPeriodDescriptorId, GradingPeriodSchoolId, GradingPeriodSchoolYear, GradingPeriodSequence, Objective, ObjectiveGradeLevelDescriptorId, StudentUSI, Id, (NEXT VALUE FOR [changes].[ChangeVersionSequence])
    FROM    deleted d
END
GO
