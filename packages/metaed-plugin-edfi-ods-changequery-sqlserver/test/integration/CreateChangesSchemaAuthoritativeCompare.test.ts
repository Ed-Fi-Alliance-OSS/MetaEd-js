...
describe('when generating change event schema and comparing to ODS/API 7.3 with DS 6.0 authoritative artifacts', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/schema/v7.3-ds60');
  const authoritativeFilename = '0010-CreateChangesSchema-authoritative.sql';
  const generatedFilename = '0010-CreateChangesSchema-generated.sql';
...
describe('when generating change event schema for extension project with ODS/API 7.3 with DS 6.0 and verifying no artifacts are generated', (): void => {
  const sampleExtensionPath: string = path.resolve(__dirname, './student-transcript-extension-project');
...
describe('when generating change event schema and comparing to ODS/API 7.3 with DS 6.1 authoritative artifacts', (): void => {
  const artifactPath: string = path.resolve(__dirname, './artifact/schema/v7.3-ds61');
  const authoritativeFilename = '0010-CreateChangesSchema-authoritative.sql';
  const generatedFilename = '0010-CreateChangesSchema-generated.sql';
...
describe('when generating change event schema for extension project with ODS/API 7.3 with DS 6.1 and verifying no artifacts are generated', (): void => {
  const sampleExtensionPath: string = path.resolve(__dirname, './student-transcript-extension-project');
