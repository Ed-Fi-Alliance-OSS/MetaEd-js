...
describe('when generating change event scripts and comparing to ODS/API 3.1 authoritative artifacts', (): void => {
  ...
  const authoritativeFilename = 'TriggerUpdateChangeVersion-v3.1-Authoritative.sql';
  const generatedFilename = 'TriggerUpdateChangeVersion-v3.1.sql';
...
describe('when generating change event scripts with simple extensions and comparing to ODS/API 3.1 authoritative artifacts', (): void => {
  ...
  const authoritativeCoreFilename = 'TriggerUpdateChangeVersion-v3.1-Authoritative.sql';
  const authoritativeExtensionFilename = 'sample-TriggerUpdateChangeVersion-v3.1-Authoritative.sql';
  const generatedCoreFilename = 'TriggerUpdateChangeVersion-v3.1.sql';
  const generatedExtensionFilename = 'sample-TriggerUpdateChangeVersion-v3.1.sql';
