...
describe('when creating columns for descriptor property role name and append parent context strategy', (): void => {
  ...
  beforeAll(() => {
    ...
    columns = columnCreatorFor(property, BuildStrategyDefault.appendParentContextProperty(parentContextProperty), '7.0.0');
  });
...
describe('when creating columns for primary key descriptor property with suppress primary key creation strategy', (): void => {
  ...
  beforeAll(() => {
    ...
    columns = columnCreatorFor(property, BuildStrategyDefault.suppressPrimaryKeyCreationFromPropertiesStrategy(), '7.0.0');
  });
