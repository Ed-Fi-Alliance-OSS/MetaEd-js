...
describe('AbstractEntityTests', () => {
    describe('When_parsing_abstract_entity_with_name_documentation_and_property', () => {
        const _entity_name = "MyIdentifier";
        const _documentation1 = "line 1 of documentation";
        const _documentation2 = "another line of intervention documentation";
        const _property_name = "Property1";
        const _property_documentation = "property intervention documentation";
        ...
        it('Should_successfully_parse', () => {
            ...
            ParserTestHelper_1.default.hasErrors(_context).should.be.false;
        });
    });
});
/*
...
*/ 
//# sourceMappingURL=AbstractEntityTests.js.map