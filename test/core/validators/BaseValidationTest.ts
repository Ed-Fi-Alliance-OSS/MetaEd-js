...
describe('CrossEntityTypeNamingValidatorTests', () => {
    ...
    describe('When_entities_have_different_names extends BaseCrossEntityTypeNamingValidatorTests', () => {
...
describe('CrossEntityTypeNamingValidatorTests', () => {
    ...
    describe('When_entities_have_same_name extends BaseCrossEntityTypeNamingValidatorTests', () => {
            public getSource(): string {
            before(() => {
            let metaEdText = MetaEdTextBuilder.buildIt
...
describe('CrossEntityTypeNamingValidatorTests', () => {
    ...
    describe('When_domain_entity_has_same_name_as_extension extends BaseCrossEntityTypeNamingValidatorTests', () => {
            public getSource(): string {
            before(() => {
            let metaEdText = MetaEdTextBuilder.buildIt
...
describe('CrossEntityTypeNamingValidatorTests', () => {
    ...
    describe('When_association_has_same_name_as_extension extends BaseCrossEntityTypeNamingValidatorTests', () => {
            public getSource(): string {
            before(() => {
            let metaEdText = MetaEdTextBuilder.buildIt
...
describe('CrossEntityTypeNamingValidatorTests', () => {
    ...
    describe('When_domain_entity_has_same_name_as_common_simple_type extends BaseCrossEntityTypeNamingValidatorTests', () => {
            public getSource(): string {
            before(() => {
            let metaEdText = MetaEdTextBuilder.buildIt
...
describe('CrossEntityTypeNamingValidatorTests', () => {
    ...
    describe('When_domain_entity_has_same_name_as_descriptor extends BaseCrossEntityTypeNamingValidatorTests', () => {
            public getSource(): string {
            before(() => {
            let metaEdText = MetaEdTextBuilder.buildIt
...
describe('CrossEntityTypeNamingValidatorTests', () => {
    ...
    describe('When_domain_entity_has_same_name_as_enumeration extends BaseCrossEntityTypeNamingValidatorTests', () => {
            public getSource(): string {
            before(() => {
            let metaEdText = MetaEdTextBuilder.buildIt
...
describe('CrossEntityTypeNamingValidatorTests', () => {
    ...
    describe('When_domain_entity_has_same_name_as_interchange extends BaseCrossEntityTypeNamingValidatorTests', () => {
            public getSource(): string {
            before(() => {
            let metaEdText = MetaEdTextBuilder.buildIt
