...
describe('MergePropertyAndTargetPropertyMustMatch', () => {
    let validatorListener = new ValidatorListener(
        new TestRuleProvider<MetaEdGrammar.MergePartOfReferenceContext>(
            new MergePropertyAndTargetPropertyMustMatch(helper.symbolTable, propertyPathLookup)));
    ...
    describe('When_merged_property_names_and_types_match', () => {
        ...
        before(() => {
            ...
            return __init(new TestRuleProvider<MetaEdGrammar.MergePartOfReferenceContext>(), { SuppliedRule: new MergePropertyAndTargetPropertyMustMatch(helper.symbolTable, propertyPathLookup) }););
});
