...
describe('MergePartOfReferenceExistsOnlyInCoreNamespace', () => {
    let validatorListener = new ValidatorListener_1.ValidatorListener(new TestRuleProvider_1.TestRuleProvider(new MergePartOfReferenceExistsOnlyInCoreNamespace()));
    describe('When_merge_exists_in_core', () => {
        ...
        return: __init(new TestRuleProvider_1.TestRuleProvider(), { SuppliedRule: new MergePartOfReferenceExistsOnlyInCoreNamespace() }) });
});
...
_extensionNamespace: string = "extension";
let helper = new ValidationTestHelper_1.ValidationTestHelper();
before(() => {
    let metaEdText = MetaEdTextBuilder_1.default.buildIt
