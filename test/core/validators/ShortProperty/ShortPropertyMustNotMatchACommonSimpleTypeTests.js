...
import { includeRule, validatable } from '../../../../src/core/validators/ShortProperty/ShortPropertyMustNotMatchACommonSimpleType';
...
describe('ShortPropertyMustNotMatchACommonSimpleTypeTests', () => {
  ...
  describe('When_short_property_has_identifier_matching_common_decimal', () => {
    ...
    it('should_have_validation_failure_message()', () => {
      helper.errorMessages()[0].message.should.include('Short property');
