    ...
    (function (Tests) {
        ...
        (function (Validator) {
            ...
            (function (CommonSimpleType) {
                class CommonShortMinValueMustNotBeGreaterThanMaxValueTests {
                    constructor() {
                        this.class = When_validating_common_short_with_no_min_or_max_value;
                    }
                }
                {
                    override;
                    ...
                    GetRuleProvider();
                    {
                        return new TestRuleProvider < MetaEdGrammar.CommonShortContext >
                            {
                                SuppliedRule: SuppliedRule = new CommonShortMinValueMustNotBeGreaterThanMaxValue()
                            };
                    }
                    [Test];
                ...
                [TestFixture];
                class When_validating_common_short_with_no_min_value {
                }
                ...
                [TestFixture];
                class When_validating_common_short_with_no_max_value {
                }
                Validator.ValidationRuleTestBase;
                {
                    override;
                ...
                [TestFixture];
                class When_validating_common_short_with_correct_min_max_value_order {
                }
                Validator.ValidationRuleTestBase;
                {
                    override;
                ...
                [TestFixture];
                class When_validating_common_short_with_min_max_values_out_of_order {
                }
                Validator.ValidationRuleTestBase;
                {
                    ...
                    MetaEdText();
                    {
                        var metaEdTextBuilder = new MetaEdTextBuilder();
                        metaEdTextBuilder.WithBeginNamespace("edfi")
                            .WithStartCommonShort(_entityName)
                            .WithDocumentation("doc")
                            .WithMinValue(100)
                            .WithMaxValue(0)
                            .WithEndCommonShort()
                ...
                [TestFixture];
                class When_validating_common_short_with_same_min_max_values {
                }
                Validator.ValidationRuleTestBase;
                {
                    override;
