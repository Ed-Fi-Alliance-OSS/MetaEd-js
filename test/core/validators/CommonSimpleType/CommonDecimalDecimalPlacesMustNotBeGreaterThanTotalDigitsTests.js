...
describe('CommonDecimalDecimalPlacesMustNotBeGreaterThanTotalDigitsTests', () => {
    let validatorListener = new ValidatorListener_1.ValidatorListener(new TestRuleProvider_1.TestRuleProvider(new CommonDecimalDecimalPlacesMustNotBeGreaterThanTotalDigits_1.CommonDecimalDecimalPlacesMustNotBeGreaterThanTotalDigits()));
