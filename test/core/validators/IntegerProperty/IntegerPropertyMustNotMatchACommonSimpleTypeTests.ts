module MetaEd.Tests.Validator.IntegerProperty {
    export class IntegerPropertyMustNotMatchACommonSimpleTypeTests {

    }
    export module IntegerPropertyMustNotMatchACommonSimpleTypeTests {
        /*[TestFixture]*/
        export class When_integer_property_has_identifier_matching_no_common_simple_types extends ValidationRuleTestBase {
            ...
            protected getRuleProvider(): MetaEd.Core.Validator.IRuleProvider {
                return __init(new TestRuleProvider<MetaEdGrammar.IntegerPropertyContext>(), { SuppliedRule: new IntegerPropertyMustNotMatchACommonSimpleType(_symbolTable) });
            }
    ...
    export module IntegerPropertyMustNotMatchACommonSimpleTypeTests {
        /*[TestFixture]*/
        export class When_integer_property_has_identifier_matching_common_decimal extends ValidationRuleTestBase {
    ...
    export module IntegerPropertyMustNotMatchACommonSimpleTypeTests {
        export class When_integer_property_has_identifier_matching_common_integer extends ValidationRuleTestBase {
            protected static _commonEntityName: string = "CommonEntityName";
            protected metaEdText(): string {
                var metaEdTextBuilder = new MetaEdTextBuilder();
    ...
    export module IntegerPropertyMustNotMatchACommonSimpleTypeTests {
        export class When_integer_property_has_identifier_matching_common_short extends ValidationRuleTestBase {
            protected static _commonEntityName: string = "CommonEntityName";
            protected metaEdText(): string {
                var metaEdTextBuilder = new MetaEdTextBuilder();
    ...
    export module IntegerPropertyMustNotMatchACommonSimpleTypeTests {
        export class When_integer_property_has_identifier_matching_common_string extends ValidationRuleTestBase {
            protected static _commonEntityName: string = "CommonEntityName";
            protected metaEdText(): string {
                var metaEdTextBuilder = new MetaEdTextBuilder();
