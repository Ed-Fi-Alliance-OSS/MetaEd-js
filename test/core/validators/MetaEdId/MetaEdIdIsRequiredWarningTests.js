...
const MetaEdIdIsRequiredWarning_1 = require("../../../../src/core/validators/MetaEdId/MetaEdIdIsRequiredWarning");
//TOOD: special case ?
let should = chai.should();
describe('MetaEdIdIsRequiredWarning', () => {
    let validatorListener = new ValidatorListener_1.ValidatorListener(new TestRuleProvider_1.TestRuleProvider(new MetaEdIdIsRequiredWarning_1.MetaEdIdIsRequiredWarning()));
...
describe('When_abstractEntity_is_missing_metaEdId extends MetaEdIdIsRequiredWarningTestBaseForEntity<MetaEdGrammar.AbstractEntityContext>, {
    let: helper, ValidationTestHelper: ValidationTestHelper_1.ValidationTestHelper = new ValidationTestHelper_1.ValidationTestHelper(),
    before() { } }(), {
