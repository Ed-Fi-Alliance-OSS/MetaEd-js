...
describe('ReplaceMeWithFileName', () => {
    ...
    describe('CrossEntityTypeNamingValidatorTests', () => {
        describe('BaseCrossEntityTypeNamingValidatorTests', () => {
            const _entityName = "MyIdentifier";
            let propertyName = "Property1";
        }, protected, _symbolTable, SymbolTable);
    }, protected, _warningMessageCollection, List());
}, protected, _errorMessageCollection, List());
...
;
describe('CrossEntityTypeNamingValidatorTests', () => {
    describe('When_entities_have_different_names extends BaseCrossEntityTypeNamingValidatorTests', () => { }, public, getSource(), string, {
        before() { } }(), {
...
;
describe('CrossEntityTypeNamingValidatorTests', () => {
    describe('When_entities_have_same_name extends BaseCrossEntityTypeNamingValidatorTests', () => { }, public, getSource(), string, {
        before() { } }(), {
        let: metaEdText = MetaEdTextBuilder.buildIt
            .withBeginNamespace("edfi")
...
;
describe('CrossEntityTypeNamingValidatorTests', () => {
    describe('When_domain_entity_has_same_name_as_extension extends BaseCrossEntityTypeNamingValidatorTests', () => { }, public, getSource(), string, {
        before() { } }(), {
        let: metaEdText = MetaEdTextBuilder.buildIt
            .withBeginNamespace("edfi")
...
;
describe('CrossEntityTypeNamingValidatorTests', () => {
    describe('When_association_has_same_name_as_extension extends BaseCrossEntityTypeNamingValidatorTests', () => { }, public, getSource(), string, {
        before() { } }(), {
        let: metaEdText = MetaEdTextBuilder.buildIt
            .withBeginNamespace("edfi")
...
;
describe('CrossEntityTypeNamingValidatorTests', () => {
    describe('When_domain_entity_has_same_name_as_common_simple_type extends BaseCrossEntityTypeNamingValidatorTests', () => { }, public, getSource(), string, {
        before() { } }(), {
        let: metaEdText = MetaEdTextBuilder.buildIt
            .withBeginNamespace("edfi")
...
;
describe('CrossEntityTypeNamingValidatorTests', () => {
    describe('When_domain_entity_has_same_name_as_descriptor extends BaseCrossEntityTypeNamingValidatorTests', () => { }, public, getSource(), string, {
        before() { } }(), {
        let: metaEdText = MetaEdTextBuilder.buildIt
            .withBeginNamespace("edfi")
...
;
describe('CrossEntityTypeNamingValidatorTests', () => {
    describe('When_domain_entity_has_same_name_as_enumeration extends BaseCrossEntityTypeNamingValidatorTests', () => { }, public, getSource(), string, {
        before() { } }(), {
        let: metaEdText = MetaEdTextBuilder.buildIt
            .withBeginNamespace("edfi")
...
;
describe('CrossEntityTypeNamingValidatorTests', () => {
    describe('When_domain_entity_has_same_name_as_interchange extends BaseCrossEntityTypeNamingValidatorTests', () => { }, public, getSource(), string, {
        before() { } }(), {
        let: metaEdText = MetaEdTextBuilder.buildIt
            .withBeginNamespace("edfi")
...
;
;
//# sourceMappingURL=BaseValidationTest.js.map