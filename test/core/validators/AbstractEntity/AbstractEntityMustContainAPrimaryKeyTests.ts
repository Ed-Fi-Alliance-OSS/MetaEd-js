module MetaEd.Tests.Validator.AbstractEntity {
    export class AbstractEntityMustContainAnIdentityTests {

    }
    export module AbstractEntityMustContainAnIdentityTests {
        /*[TestFixture]*/
        export class When_validating_domain_entity_with_identity_fields extends ValidationRuleTestBase {
            ...
            protected getRuleProvider(): MetaEd.Core.Validator.IRuleProvider {
                return __init(new TestRuleProvider<MetaEdGrammar.AbstractEntityContext>(), { SuppliedRule: new AbstractEntityMustContainAnIdentity() });
            }
